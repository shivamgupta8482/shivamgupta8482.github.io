            ...
            <Wrap spacing="20px" justify="center">
              ...
              <Stack spacing={3} >
                ...
                >
                  ...
                  <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcRwRfGGtRlHqhPfnMkGQNPsnqRpjBLdcdLmqjvjhTZmDHRWfJJKllDcBNHqDbBLTqNdFbbjx">
                    <Button
                      leftIcon=<Image
                        boxSize="20px"
                        objectFit="cover"
                ...
                <Button colorScheme="red" borderColor="green.500">
                  Button
                </Button>
              </Stack>
            </Wrap>
        ...
        <div style={{ width: "70%", margin: "auto" }}>
          ...
          <div id="contact">
            ...
            <Wrap spacing="50px" justify="center">
             ...
             <Center>
             <Button style={{width:"50%"}} colorScheme="red">
                  Button
                </Button>
             </Center>
              </Stack>
